                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="footer-widget-area mb-100">
                            ...
                            <!-- Address -->
                            <div class="address">
                                <h6><img src="asset/frontend/img/icons/phone-call.png" alt=""> +45 677 8993000 223</h6>
                                <h6><img src="asset/frontend/img/icons/envelope.png" alt=""> office@template.com</h6>
                                <h6><img src="asset/frontend/img/icons/location.png" alt=""> Main Str. no 45-46, b3, 56832, Los
                                    Angeles, CA</h6>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget-area mb-100">
                            ...
                            <div class="featured-properties-slides owl-carousel">
                                ...
                                <div class="single-featured-properties-slide">
                                    <a href="#"><img src="asset/frontend/img/bg-img/fea-product.jpg" alt=""></a>
                                </div>
                                <!-- Single Slide -->
                                <div class="single-featured-properties-slide">
                                    <a href="#"><img src="asset/frontend/img/bg-img/fea-product.jpg" alt=""></a>
